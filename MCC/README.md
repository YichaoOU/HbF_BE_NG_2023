...
The results were generated using the Micro-C pipeline here: https://hemtools.readthedocs.io/en/latest/content/NGS_pipelines/MicroC.html

Users have to download the Perl script here: https://github.com/jojdavies/Micro-Capture-C and they need to install dependencies such as `trim_galore`, `FLASH`, `BLAT`, `bowtie`, etc.

The pipeline is a BASH script below:
